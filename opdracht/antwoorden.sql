...
-- Opdracht 2 
SELECT * FROM videogamesales WHERE year='1998'

-- Opdracht 3
SELECT * FROM videogamesales WHERE genre='sports' AND NA_Sales

-- Opdracht 4
SELECT name, platform FROM videogamesales WHERE year='1990' or year='1991' or year='1992' or year='1993' or year='1993' or year='1995' or year='1996' or year='1997' or year='1998' or year='1999' or year='2000' or year='2001'or year='2002'or year='2003' or year='2004' or year='2005'

-- Opdracht 5
SELECT name, platform, global_sales FROM videogamesales WHERE Global_Sales ORDER BY global_sales DESC

-- Opdracht 6 
SELECT AVG(genre='puzle') FROM videogamesales WHERE EU_sales
...
-- Opdracht 9
SELECT name, year FROM videogamesales WHERE genre='racing' AND publisher='nintendo' OR publisher='activission'
...
-- Opdracht 15
DELETE FROM videogamesales WHERE year='1997' AND NA_Sales>'2000000'